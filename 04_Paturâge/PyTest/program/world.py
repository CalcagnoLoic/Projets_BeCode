...
class Zone:
    ...
    def contains(self, position):
        ...
        return min(self.corner1.longitude, self.corner2.longitude) <= position.longitude < max(self.corner1.longitude,
                                                                                               self.corner2.longitude) and \
               min(self.corner1.latitude, self.corner2.latitude) <= position.latitude < max(self.corner1.latitude,
